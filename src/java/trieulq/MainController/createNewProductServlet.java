...
public class createNewProductServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        CategoriesDAO categoryDAO = new CategoriesDAO(); // You need to replace CategoryDAO with your actual DAO class
        CategoriesDTO categoryDTO = categoryDAO.getCategoriesByID(categoryID);
        String url = Error;
        ...
        try {
            ...
            boolean result = dao.createProduct(new ProductDTO(productID, productName, categoryDTO, quantityPerUnit, unitPrice, productImage));
            if(result){
                url = SUCCESS;
                request.setAttribute("Mess", "Create the new Product successfully");
